                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <p className="text-blue-800 text-sm">
                          ...
                          morning journaling to start your day with intention.
                        </p>
                      </div>
                      <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                        ...
                        <p className="text-green-800 text-sm">
                          You've mentioned your fitness goals 3 times this week.
                          Your consistency in tracking shows strong commitment
                      ...
                      <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                        ...
                        <p className="text-purple-800 text-sm">
                          Your mood entries show a positive trend this week. The
                          activities you've been doing seem to be contributing
                          to your well-being.
                        </p>
                      </div>
                    </div>
