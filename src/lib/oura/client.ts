...
class OuraClient {
  ...
  async getSleepData(
    ...
    return this.makeRequest<OuraSleepData>(
  ...
  async getActivityData(
    ...
    return this.makeRequest<OuraActivityData>(
  ...
  async getReadinessData(
    ...
    return this.makeRequest<OuraReadinessData>(
  ...
  async getHeartRateData(
    ...
    return this.makeRequest<OuraHeartRateData>(
      `/usercollection/heartrate?start_date=${startDate}&end_date=${endDate}`
    );
  }
