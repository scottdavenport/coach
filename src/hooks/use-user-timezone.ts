    ...
    try {
      ...
      if (fetchError) {
        ...
        if (
          ...
          console.log(
            'Timezone column not found, using detected timezone as default'
          );
      ...
      try {
        ...
        if (updateError) {
          ...
          if (
            ...
            console.log(
              'Timezone column not found, cannot update timezone preference'
            );
            setError(
              'Timezone feature not available yet - migration may not be applied'
            );
            return;
          }
