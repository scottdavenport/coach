...
export function SettingsModal({ isOpen, onClose, userId }: SettingsModalProps) {
  const [activeTab, setActiveTab] = useState<'integrations' | 'preferences' | 'data'>('integrations')
  ...
  const handleOuraConnect = async (accessToken: string, refreshToken: string) => {
    try {
              ...
              <div className="bg-card/60 backdrop-blur-sm border border-line/40 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={ouraConnected ? 'text-green-500' : 'text-muted-foreground'}>
                  ...
                  {ouraConnected && ouraIntegration?.last_sync_at && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        {new Date(ouraIntegration.last_sync_at).toLocaleString()}
                      </span>
                    </div>
                  )}
                ...
                <div className="bg-muted/30 border border-line/30 rounded-lg p-4 opacity-60">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Sync health and fitness data</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-muted/30 border border-line/30 rounded-lg p-4 opacity-60">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Sync activity and sleep data</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-card/60 backdrop-blur-sm border border-line/40 rounded-lg p-4">
                  ...
                  <Button size="sm" variant="outline" className="flex items-center gap-2 text-orange-600 border-orange-600 hover:bg-orange-50">
