...
export const DailyWorkoutModal = forwardRef<
            ...
            <>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {activity.planned_data &&
                                Object.keys(activity.planned_data).length >
                                  0 && (
                                  <div className="text-xs text-muted-foreground mt-1">
                                    {activity.planned_data.exercises && (
                                      <span>
                                        {activity.planned_data.exercises.length}{' '}
                                        exercises
                                      </span>
                                    )}
                ...
                {completedActivities.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {completedActivities.map(activity => (
                      <div
                        key={activity.id}
                        className="border border-line rounded-lg p-4 bg-green-50/10"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            {getActivityIcon(activity.activity_type)}
                            <div>
                              ...
                              {activity.completed_data &&
                                Object.keys(activity.completed_data).length >
                                  0 && (
                                  <div className="text-xs text-muted-foreground mt-1">
              ...
              <div className="border border-line rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Upload a screenshot from Strava or HealthFit to automatically
