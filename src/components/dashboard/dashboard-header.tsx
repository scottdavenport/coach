  ...
  const handleResetUserData = async () => {
    ...
    try {
      ...
      if (userProfile?.email === 'scott@thinkcode.com') {
        alert(
          '❌ Cannot reset data for scott@thinkcode.com user account. This account is protected.'
        );
        return;
      }
      ...
      console.log(
        `🧹 Reset complete: ${clearedCount} tables cleared, ${errorCount} errors`
      );
      ...
      alert(
        '❌ Critical error during data reset. Please check the console and try again.'
      );
    } finally {
