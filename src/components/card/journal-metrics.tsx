...
export function JournalMetrics({ userId, date }: JournalMetricsProps) {
  ...
  const updatePreference = async (
    key: keyof UserMetricPreferences,
    value: boolean
  ) => {
    try {
          ...
          <div className="grid grid-cols-2 gap-2">
            <label className="flex items-center space-x-2 text-sm">
              <Checkbox
                ...
                onCheckedChange={checked =>
                  updatePreference('sleep_score', checked as boolean)
                }
              />
            ...
            <label className="flex items-center space-x-2 text-sm">
              <Checkbox
                ...
                onCheckedChange={checked =>
                  updatePreference('readiness', checked as boolean)
                }
              />
              <span>Readiness</span>
            </label>
            <label className="flex items-center space-x-2 text-sm">
              <Checkbox
                ...
                onCheckedChange={checked =>
                  updatePreference('weight', checked as boolean)
                }
              />
              <span>Weight</span>
            </label>
            <label className="flex items-center space-x-2 text-sm">
              <Checkbox
                ...
                onCheckedChange={checked =>
                  updatePreference('weekly_weight_avg', checked as boolean)
                }
              />
