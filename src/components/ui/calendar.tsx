...
export function Calendar({
  ...
  return (
    <div className={`relative inline-block ${className}`}>
      {/* Calendar Toggle Button - shows current selected date */}
      <Button
        variant="outline"
      ...
      >
        ...
        {formatDateInTimezone(selectedDate, 'month-day', preferredTimezone)}
      </Button>

      {/* Calendar Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-[100] p-4 min-w-[320px] max-w-[320px]">
          {/* Calendar Header */}
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex text-center justify-center gap-2 w-full">
